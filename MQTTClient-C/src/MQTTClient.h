 ...
 *
 * Contributors:
 *    Allan Stockdill-Mander/Ian Craggs - initial API and implementation and/or initial
 *documentation Ian Craggs - documentation and platform specific header Ian Craggs - add
...
#define MAX_MESSAGE_HANDLERS 5 /* redefinable - how many subscriptions do you want? */
	...
	typedef struct MQTTClient
	{
		...
		struct MessageHandlers
		{
			...
			void (*fp)(MessageData*);
		} messageHandlers[MAX_MESSAGE_HANDLERS]; /* Message handlers are indexed by subscription
		                                          * topic
		                                          */
...
#define DefaultClient                                                                              \
	 ...
	 *  @return success code
	 */
	DLLExport int MQTTSubscribe(MQTTClient* client, const char* topicFilter, enum QoS,
	                            messageHandler);
	 ...
	 *  @return success code
	 */
	DLLExport int MQTTSubscribeWithResults(MQTTClient* client, const char* topicFilter, enum QoS,
